...
def train(start_rank, tolerance, load_model):
    ...
    filename = "cifar100_conv_sr" + str(start_rank) + "_v" + str(tolerance)
    folder_name = "cifar100_conv_sr" + str(start_rank) + "_v" + str(tolerance) + '/latest_model'
    folder_name_best = "cifar100_conv_sr" + str(start_rank) + "_v" + str(tolerance) + '/best_model'

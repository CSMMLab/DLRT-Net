...
from .dense_layers import Linear, DLRTLayer, DLRTLayerAdaptive, DLRTLayerParallel
...
class DLRTNetParallel(keras.Model):

    def __init__(self, input_dim=1, output_dim=1, name="e2eDLRANet", tol=0.4, low_rank=20, dlra_layer_dim=200,
                 rmax_total=100, **kwargs):
        super(DLRTNetParallel, self).__init__(name=name, **kwargs)
        # dlra_layer_dim = 250
        self.dlraBlockInput = DLRTLayerParallel(input_dim=input_dim, units=dlra_layer_dim, low_rank=low_rank,
                                                epsAdapt=tol,
                                                rmax_total=rmax_total, )
        self.dlraBlock1 = DLRTLayerParallel(input_dim=dlra_layer_dim, units=dlra_layer_dim, low_rank=low_rank,
                                            epsAdapt=tol,
                                            rmax_total=rmax_total, )
        self.dlraBlock2 = DLRTLayerParallel(input_dim=dlra_layer_dim, units=dlra_layer_dim, low_rank=low_rank,
                                            epsAdapt=tol,
                                            rmax_total=rmax_total, )
        self.dlraBlock3 = DLRTLayerParallel(input_dim=dlra_layer_dim, units=dlra_layer_dim, low_rank=low_rank,
                                            epsAdapt=tol,
                                            rmax_total=rmax_total, )
        self.dlraBlockOutput = Linear(input_dim=dlra_layer_dim, units=output_dim)

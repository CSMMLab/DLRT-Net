...
function dNetworkK1(K1::Array{Float64,2},V1::Array{Float64,2},U2::Array{Float64,2},S2::Array{Float64,2},V2::Array{Float64,2},x::Array{Float64,1},y::Array{Float64,1})
    #an = Wn*znM
    #zn = ReLU(an)
    V1Tx = V1'*x;  # input layer 1
    a1 = K1*V1Tx;  # pre-activation layer 1
    z1 = ReLU(a1); # output layer 1
    
    V2Tz1 = V2'*z1     #input layer 2
    a2 = U2*S2*V2Tz1;  #pre-activation layer 2 
    z2 = ReLU(a2);     #output layer 2

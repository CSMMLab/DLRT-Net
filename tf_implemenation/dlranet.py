...
class FullDLRANet_learned_tol(keras.Model):
    ...
    def __init__(self, input_dim=1, output_dim=1, name="partDLRANet", tol=0.4, low_rank=20, rmax_total=100, **kwargs):
        super(FullDLRANet_learned_tol, self).__init__(name=name, **kwargs)
        dlra_layer_dim = 250
        self.denseBlock = DenseBlock(units=250, input_dim=input_dim)
        self.dlraBlock1 = DLRALayer_l_t(input_dim=dlra_layer_dim, units=dlra_layer_dim, low_rank=low_rank, epsAdapt=tol,
                                        rmax_total=rmax_total, )
        self.dlraBlock2 = DLRALayer_l_t(input_dim=dlra_layer_dim, units=dlra_layer_dim, low_rank=low_rank, epsAdapt=tol,
                                        rmax_total=rmax_total, )
        self.dlraBlock3 = DLRALayer_l_t(input_dim=dlra_layer_dim, units=dlra_layer_dim, low_rank=low_rank, epsAdapt=tol,
                                        rmax_total=rmax_total, )
